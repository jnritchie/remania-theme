				...
				<div class="section-inner">
					...
					<div class="footer-credits">
						...
						<p class="footer-copyright">&copy;
							...
							?>
							<a href="<?php echo esc_url("https://github.com/jnritchie"); ?>"><?php echo bloginfo( 'name' ); ?></a>
						</p><!-- .footer-copyright -->

						<p class="powered-by-wordpress">
							<a href="https://github.com/jnritchie">
								Made with &#9825; by <span style="font-weight: bold;">Justin Ritchie</span>
							</a>
